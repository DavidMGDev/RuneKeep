    ...
    <OverlayShell title="Modifiers" subtitle={subtitle} onClose={onClose}>
      ...
      {EFFECT_TARGETS.map((t) => {
        ...
        return (
          ...
          <View key={t} style={{ paddingVertical: 10, paddingHorizontal: 13, borderRadius: 4, backgroundColor: 'rgba(20,24,31,0.6)', borderWidth: has ? 1.3 : 1, borderColor: has ? Rune.red : 'rgba(218,162,73,0.35)' }}>
